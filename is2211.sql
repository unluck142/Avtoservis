...
--
-- Хост: 127.0.0.1
-- Время создания: Июл 04 2026 г., 11:07
...
INSERT INTO `appointments` (`id`, `user_id`, `date`, `time`, `service_type`, `comments`, `status`, `created_at`) VALUES
(1, 2, '2026-07-29', '15:00:00', '2', NULL, 'pending', '2026-06-01 10:06:40');
...
(13, 'Оськин', 'Патриотов213231', '89069756331', '12qwerqf@gmail.com', 6000, '2026-06-01 17:06:40', 2, 1);
...
(1, 'Проверка машини', 'Проверяем вашу машину на проблемы', '	\n/avtoservis/assets/images/proverka.png', 6999.00, '2025-04-07 12:45:45', '2026-05-14 03:09:31'),
(2, 'Замена масла', 'Заменяем масло', '/avtoservis/assets/images/oil.png', 6000.00, '2025-04-07 12:45:45', '2026-05-14 03:09:06'),
(3, 'Ремонт', 'Ремонтируем вашу машину', '/avtoservis/assets/images/remont.png', 4000.00, '2025-04-07 12:45:45', '2026-05-14 03:09:55');
...
(2, 'admin', NULL, 'kachkaryov2010@gmail.com', '$2y$10$e4HuMUyCZVEIn.HhnCKi6ejqBBZ6k2erBISpPEzv4w6xJYW4qmuYW', '', 1, '2025-04-24 21:10:45', 'Патриотов213231', '89511683163123', '/avtoservis/assets/uploads/avatar_2_1780307242.png'),
